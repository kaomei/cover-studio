...
クリエイター、個人開発者、テックブロガーのためのオープンソース AI Skill。記事入力時に**大見出し・副見出し・タグ要素の文字階層をまず確認**し、その文字を基に**3種類の異なるデザイン画像を直接生成・提示**。お好みのスタイルを確認した後に**必要なプラットフォームサイズを自由に選択して一括出力**し、ブランドシステム固定化にも対応。**Codex 環境直接生成**と **Nano Banana (Google Flow 無料) プロンプト出力**に対応。

![Codex Skill](https://img.shields.io/badge/Codex-Skill-111827?style=flat-square)
![9大オープンソースエンジン](https://img.shields.io/badge/統合エンジン-9大オープンソースSkill-0066ff?style=flat-square)
![マルチサイズ一括](https://img.shields.io/badge/対応サイズ-3%3A4%20%7C%202.35%3A1%20%7C%2016%3A9%20%7C%205%3A2-f59e0b?style=flat-square)
...
- **3スタイル提示後にマルチサイズへ一括展開**：実物を見て選択してから各プラットフォーム向けに一括生成。
...
- 📐 **スタイル決定後にサイズを自由選択**：お気に入りのスタイルを選んでから、出力したいプラットフォーム（RED 3:4、WeChat 2.35:1、X 16:9/5:2、動画 16:9 等）を一括出力。
...
flowchart TD
    ...
    --> A1["<b>1. 記事入力 ➔ 文字階層の先行確認</b> ： 📌 大見出し (≤8文字) ＋ 📝 副見出し価値 ＋ 🏷️ カプセルタグ"]:::highlightNode
    --> A2["<b>2. 3スタイル直接生成</b> ： 【サイバーギーク】·【大見出しバズ】·【深度コラム】の3案を直接提示"]:::stepNode
    --> A3["<b>3. スタイル選択 ➔ 展開サイズ指定</b> ： 心意のスタイル (A/B/C) 決定 ➔ 出力希望サイズにチェック"]:::highlightNode
    --> A4["<b>4. 全サイズ一括納品 ＋ ブランド固定</b> ： Codex 直接生成 または Google Flow (Nano Banana) 無料出図"]:::stepNode
```
