...
flowchart TD
    ...
    --> A1["<b>0. 初期設定 (初回のみ)</b> ： 出力モード選択（ブランド統一マルチサイズ / 単一サイズ個別）"]:::stepNode
    --> A2["<b>1. 文字階層の先行確認</b> ： 📌 大見出し (≤8文字) ＋ 📝 副見出し価値 ＋ 🏷️ カプセルタグ"]:::highlightNode
    --> A3["<b>2. 3スタイル直接生成</b> ： 【サイバーギーク】·【大見出しバズ】·【深度コラム】の3案を直接提示"]:::stepNode
    --> A4["<b>3. 選択 ➔ 自選サイズ一括納品</b> ： Codex 直接生成 または Google Flow (Nano Banana) 無料出図"]:::stepNode
```
