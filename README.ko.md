...
크리에이터, 1인 개발자, 테크 블로거를 위한 오픈소스 AI Skill. 글 입력 시 **메인 헤드라인·서브 카피·태그 요소의 텍스트 계층을 먼저 확인**하고, 정렬된 문구를 바탕으로 **서로 다른 3가지 스타일 이미지를 즉시 생성·제시**합니다. 마음에 드는 스타일을 고른 후 **원하는 플랫폼 규격을 자유롭게 선택하여 일괄 출력**하고 브랜드 시스템(Brand System)을 고정할 수 있습니다. **Codex 환경 직접 생성**과 **Nano Banana (Google Flow 무료 플랫폼) 프롬프트 출력**의 듀얼 패스를 지원합니다.

![Codex Skill](https://img.shields.io/badge/Codex-Skill-111827?style=flat-square)
![9대 오픈소스 엔진](https://img.shields.io/badge/통합%20엔진-9대%20오픈소스%20Skill-0066ff?style=flat-square)
![자유로운 규격 확장](https://img.shields.io/badge/지원%20규격-3%3A4%20%7C%202.35%3A1%20%7C%2016%3A9%20%7C%205%3A2-f59e0b?style=flat-square)
...
- **3가지 스타일 확인 후 멀티 규격 일괄 확장**: 눈으로 직접 확인하고 선택한 후 각 플랫폼에 맞게 일괄 출력.
...
- 📐 **스타일 확정 후 규격 자유 확장**: 마음에 드는 스타일을 고른 후 필요한 플랫폼 비율(샤오홍슈 `3:4`, 위챗 `2.35:1`, X 포스트 `16:9`, X 아티클 `5:2`, 영상 `16:9` 등)을 선택해 일괄 출력.
...
flowchart TD
    ...
    --> A1["<b>1. 글 입력 ➔ 텍스트 계층 선행 확인</b> ： 📌 메인 헤드라인 (≤8단어) ＋ 📝 서브 카피 ＋ 🏷️ 캡슐 태그"]:::highlightNode
    --> A2["<b>2. 3가지 스타일 즉시 생성</b> ： 【사이버 긱】·【볼드 헤드라인】·【심층 저널】3가지 결과물 즉시 제시"]:::stepNode
    --> A3["<b>3. 스타일 선택 ➔ 확장 규격 체크</b> ： 원하는 스타일 (A/B/C) 확정 ➔ 일괄 생성할 플랫폼 비율 체크"]:::highlightNode
    --> A4["<b>4. 전 규격 일괄 납품 ＋ 브랜드 고정</b> ： Codex 직접 렌더링 또는 Google Flow (Nano Banana) 무료 생성"]:::stepNode
```
