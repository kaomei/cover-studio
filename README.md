...
```mermaid
flowchart TD
    subgraph S0["⚙️ 首次配置 (仅首次安装/唤醒【万能封面 Skill】时确认)"]
        A0[用户安装/唤醒【万能封面 Skill】] --> A1[确认出图偏好模式:<br/>• 模式 1: 🌟 统一品牌多尺寸分发模式<br/>• 模式 2: 🎯 单尺寸独立定制模式]
        A1 -->|选择模式 1| A2[用户自主勾选常驻批量输出的独立尺寸清单:<br/>小红书 3:4 / 公众号 2.35:1 / X 16:9 / X长文 5:2 / 视频 16:9 / GitHub 2:1 / 1:1 正方形]
    end
    ...
    subgraph S3["🚀 阶段三：用户挑选 ➔ 自选多尺寸一键批量交付"]
        ...
        D1 -->|统一品牌多尺寸模式| D2[一键批量交付阶段 0 勾选的全部独立尺寸资产:<br/>例如: 小红书 3:4 + 公众号 2.35:1 + X 16:9]
