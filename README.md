...
一款专为自媒体创作者、独立开发者、专栏作家与科技博主打造的开源 AI Skill。告别封面选择困难症与风格大乱炖！安装即问出图偏好，输入文章内容**首先确认大字标题/副标题/标签文字层级**；随后**直接并行输出 3 种不同风格的成图或提示词**；选定后支持**全平台多尺寸一键批量出图**与品牌固化，支持 **Codex 环境直接出图** 与 **Nano Banana (Google Flow 免费平台) 提示词** 双路径交付。
...
> **Skill 回复**：
> ```markdown
> 🎨 已根据确认的文字，为您直接生成 3 种不同流派的封面结果：
> 
> 【风格 A：赛博极客风】（基于 punk-cover）
> 📐 画幅：16:9 / 5:2
> 📝 Prompt: High-end editorial tech cover illustration, aspect ratio 16:9, clean off-white background with subtle circuit grid... Text: "普通人翻盘", "AI 时代个人商业闭环与实操指南", "[实操干货]"...
> 
> 【风格 B：小红书爆款大字风】（基于 atutun-xhs / ponyo）
> 📐 画幅：3:4 竖版
> 📝 Prompt: Viral Xiaohongshu style knowledge guide cover, vertical 3:4, large bold yellow card "普通人翻盘", supporting text "AI 时代个人商业闭环与实操指南"...
> 
> 【风格 C：微信公众号深度长文风】（基于 knowledge-media）
> 📐 画幅：2.35:1（通过 1:1 居中测试）
> 📝 Prompt: Sophisticated editorial publication header banner, ultra-wide 2.35:1, warm ivory paper background #F7F5EE...
> 
> 👉 请回复您选中的风格（A / B / C）！
> ```
